...
export const getAllUnAvailableDates = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BACKEND_API_URL}/unAvailableDates/getAll`);
...
export const addUnAvailableDates = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_API_URL}/unAvailableDates/addNew`, data);
      return response.data;
    } catch (error) {
      return rejectWithValue(
        error.response ? error.response.data : "An error occurred"
...
export const updateUnAvailableDates = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_API_URL}/unAvailableDates/update`, data);
      return response.data;
    } catch (error) {
      return rejectWithValue(
        error.response ? error.response.data : "An error occurred"
...
export const deleteUnAvailableDates = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_API_URL}/unAvailableDates/delete`, { id });
      return response.data;
    } catch (error) {
      return rejectWithValue(
        error.response ? error.response.data : "An error occurred"
